...
It draws all tiles, sprites, and an optional background image centered
around the position of the player.

<p>If the width of the background is smaller than the tile map, the 
background image will appear to move slowly, creating a parallax background
effect.

<p>Also, three static methods are provided to convert pixels to tile positions,
and vice-versa.
...
public class TileMapRenderer
{
	...
	public static int pixelsToTiles(int pixels)
	{
		...
		/*or, for tile sizes that aren't a power of two, use the
		 floor function:
	...
	{
		/*No real reason to use shifting here. It's slightly
		 faster, but doesn't add up to much on modern 
		 processors */
		return numTiles << TILE_SIZE_BITS;

		/*Use this if the tile size isnt a power of 2: 
	...
	{
		Sprite player=(Sprite)map.getPlayer();
		...
		while(i.hasNext())
		{
			...
			//wake up the creature when its on screen
